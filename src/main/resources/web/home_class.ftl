            ...
            <article role="article">
                ...
                <ul style="list-style:none;text-align:center;margin-top:30px;">
                    ...
                    <#if (maxPageNum > pageNum)>
                        <a href="/page/${classCode}/${pageNum+1}/" style="float:left;">← 较旧的日志</a>
                    </#if>
                    <#if (pageNum > 1)>
                        <a href="/page/${classCode}/${pageNum-1}/" style="float:right;">较新的日志 →</a>
                    <#elseif pageNum ==1>
                        <#if (maxPageNum > 1) >
                            <a href="/page/${classCode}/1" style="float:right;">较新的日志 →</a>
                        </#if>
                    </#if>
                    </li>
